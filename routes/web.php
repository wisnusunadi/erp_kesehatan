...
Route::post('/daftar_karyawan/data', 'KaryawanController@karyawan_data');
...
/* Get Data */
Route::post('/kesehatan/data', 'KesehatanController@kesehatan_data');
...
Route::post('/kesehatan/vaksin/{karyawan_id}', 'KesehatanController@kesehatan_vaksin');
Route::post('/kesehatan/penyakit/{karyawan_id}', 'KesehatanController@kesehatan_riwayat_penyakit');
...
/* Get Data */
Route::post('/kesehatan_mingguan_tensi/data', 'KesehatanController@kesehatan_mingguan_tensi_data');
Route::post('/kesehatan_mingguan_rapid/data', 'KesehatanController@kesehatan_mingguan_rapid_data');
/* Get Detail */
...
Route::post('/kesehatan_bulanan_gcu/data', 'KesehatanController@kesehatan_bulanan_gcu_data');
Route::post('/kesehatan_bulanan_berat/data', 'KesehatanController@kesehatan_bulanan_berat_data');
Route::get('/kesehatan_bulanan/detail', 'KesehatanController@kesehatan_bulanan_gcu_detail');
Route::post('/kesehatan_bulanan_berat/detail/{karyawan_id}', 'KesehatanController@kesehatan_bulanan_berat_detail_data');
...
Route::post('/kesehatan_tahunan/data', 'KesehatanController@kesehatan_tahunan_data');
...
Route::post('/karyawan_sakit/data', 'KesehatanController@karyawan_sakit_data');
...
Route::post('/karyawan_masuk/data', 'KesehatanController@karyawan_masuk_data');
...
Route::post('/obat/data', 'KesehatanController@obat_data');
...
Route::post('/obat/data/detail/{karyawan_id}', 'KesehatanController@obat_detail_data_karyawan');
